...
namespace PartlyNewsy.Core
{
    public class BingNewsService : INewsService
    {
        ...
        {
            ApiKeyServiceClientCredentials creds = new ApiKeyServiceClientCredentials(Constants.BingAPIKey);

            searchClient = new NewsSearchClient(creds) { Endpoint = Constants.BingUrl };
        }
